...
class StatisticsAdminHandler(AdminHandler):
    ...
    def get(self, stream_id):
        ...
        self.template_vars["submenu"] = "statistics"
        self.template_vars["stream_id"] = stream_id
        self.template_vars["stream"] = stream

        self.render("admin/statistics.html", **self.template_vars)

class ListenersStatisticsAdminHandler(AdminHandler):
