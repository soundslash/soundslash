...
(function (global) {
    ...
    var dev = navigator.device, ui = {},
        ...
        options = {
            stylesheet: MCParam('stylesheet') || "/static/js/styles/lib/mediacapture.css"
          , swf: MCParam('swf') || "/static/assets/MediaCapture.swf"
...
//            wrapper.appendChild(menu);
            ...
            $('#mic-allow')[0].appendChild(wrapper);
    ...
    ui = {
        ...
        show: function (captureCb, stopCb) {
            ...
            var recording = null;
            $('#record')[0].addEventListener("click", function (event) {
                if (recording == null)
                {
                    recording = true;
                    captureCb();
